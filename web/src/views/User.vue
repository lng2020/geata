...
<!-- Add Rule Dialog -->
<div v-if="showAddRuleDialog" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
  <div class="bg-white p-6 rounded-md">
    <h3 class="text-xl font-bold mb-4">Add Alarm Rule</h3>
    <div class="mb-4">
      <label class="block mb-1">Condition:</label>
      <input type="text" v-model="newRule.condition" class="w-full border border-gray-300 px-2 py-1 rounded-md" />
    </div>
    <div class="mb-4">
      <label class="block mb-1">Notification:</label>
      <input type="text" v-model="newRule.notification" class="w-full border border-gray-300 px-2 py-1 rounded-md" />
    </div>
    <div class="flex justify-end">
      <button @click="addRule" class="px-4 py-2 bg-blue-500 text-white rounded-md">
        Add
      </button>
      <button @click="showAddRuleDialog = false" class="ml-2 px-4 py-2 bg-gray-500 text-white rounded-md">
        Cancel
      </button>
    </div>
  </div>
