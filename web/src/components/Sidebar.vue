<template>
  <div class="h-screen bg-indigo-950" :class="sidebarVisible ? 'w-72' : 'w-15'">
    <div class="mb-2 relative flex items-center">
      ...
      <span class="text-white text-2xl font-extrabold" :class="{ hidden: !sidebarVisible }"
        >Geata</span
      >
    ...
    <ul>
      <li class="mb-4 flex items-center">
        <font-awesome-icon
          ...
          class="text-white text-2xl ml-6 mr-4"
        ></font-awesome-icon>
        <router-link to="/" class="text-white text-xl ml-2" :class="{ hidden: !sidebarVisible }"
        ...
        <div class="mb-4 flex items-center">
          ...
          <div :class="{ hidden: !sidebarVisible }">
            ...
            <font-awesome-icon
              ...
              class="text-white text -right-4"
              :class="{ 'rotate-180': !station.showOptions }"
            ></font-awesome-icon>
          </div>
        </div>
